  ...
  return (
    <Card className="overflow-hidden">
      ...
      <CardContent className="!p-3 !pt-0 sm:!p-6 sm:!pt-0 space-y-4 sm:space-y-6">
        ...
        {/* Reativação Automática - só aparece se stop_bot_from_me estiver ativo */}
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-xs p-3">
                      ...
                      <p className="text-xs leading-relaxed">
                        Após você responder manualmente, o bot ficará pausado.
                        Defina o tempo para reativação automática ou deixe em 0 para reativar apenas pelo painel.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>

...
import { Instagram, Facebook, Globe, BarChart3, Target, MessageCircle, MapPin, Code, AlertTriangle, Lock } from "lucide-react";
import { useState } from "react";
import { MapLocationPicker } from "../MapLocationPicker";
import { useModuleAccess } from "@/components/admin/ModuleGate";
...
export function ContactStep({ formData, updateFormData, storeId }: ContactStepProps) {
  const [showMapPicker, setShowMapPicker] = useState(false);
  const { hasAccess: hasCustomScriptsAccess, loading: loadingCustomScripts } = useModuleAccess('custom_scripts', storeId || null);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Scripts Personalizados - Controlado por Módulo */}
      {hasCustomScriptsAccess && (
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center">

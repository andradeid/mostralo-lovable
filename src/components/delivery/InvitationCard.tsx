...
import { Building2, Calendar, DollarSign, Percent, Shield } from 'lucide-react';
      ...
      <CardContent className="space-y-3">
        ...
        <div className="rounded-lg bg-primary/5 border border-primary/10 p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            ) : invitation.proposed_payment_type === 'minimum_guaranteed' ? (
          ...
          <p className="text-2xl font-bold text-primary">
            {invitation.proposed_payment_type === 'fixed'
              ...
              : invitation.proposed_payment_type === 'minimum_guaranteed'
                ? formatCurrency(invitation.proposed_minimum_amount || 0)
          ...
          <p className="text-xs text-muted-foreground mt-1">
            {invitation.proposed_payment_type === 'fixed'
              ? 'Por entrega'
              : invitation.proposed_payment_type === 'minimum_guaranteed'
                ? 'Mínimo por entrega (ou taxa se maior)'
                : 'Da taxa de entrega'}
          </p>
        </div>

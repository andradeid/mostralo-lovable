export const copyPageText = `# GUIA COMPLETO DO MOSTRALO - TODAS AS FUNCIONALIDADES
...
## CARDÁPIO NA MESA (QR CODE) - NOVO!
⭐ FUNCIONALIDADE EXCLUSIVA PARA RESTAURANTES E BARES

Como Funciona:
1. QR Code na mesa - cliente escaneia com celular
2. Cardápio abre no navegador (sem precisar baixar app)
3. Cliente adiciona itens à comanda digital
4. Aprovação opcional pelo garçom antes de ir para cozinha
5. Pedido vai direto para KDS/impressora

Benefícios:
- Reduz 70% do tempo de atendimento
- Zero erros de anotação (cliente escolhe sozinho)
- Garçom só aprova e entrega
- Aumenta +25% rotatividade de mesas
- Senha de segurança configurável por mesa
- Histórico de consumo em tempo real
- Divisão de conta automática
- Integração total com KDS e comandas

Ideal para: Restaurantes, bares, pizzarias, hamburguerias, lanchonetes com mesas

...
export function TableMenuSection() {
  return (
    <section className="py-20 bg-gradient-to-br from-purple-50 via-background to-blue-50 dark:from-purple-950/20 dark:via-background dark:to-blue-950/20 overflow-hidden">

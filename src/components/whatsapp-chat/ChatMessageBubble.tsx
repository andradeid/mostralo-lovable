...
export function ChatMessageBubble({ message, onReply, onReact, onEdit, onDelete, onRegisterLocation, allMessages }: ChatMessageBubbleProps) {
  ...
  return (
    <div
      className={cn('flex mb-2 group overflow-hidden', isOutgoing ? 'justify-end' : 'justify-start')}
    ...
    >
      ...
      <div className="relative max-w-[75%] min-w-0 overflow-hidden">
        <div
          className={cn(
            'rounded-2xl px-3.5 py-2.5 text-sm transition-all duration-200 break-words [overflow-wrap:anywhere] overflow-hidden',
            isOutgoing

...
export const routePreloadMap: Record<string, RouteImportFn> = {
  ...
  '/dashboard/mesas-qrcode': () => import('@/pages/admin/TableQRCodePage'),
  ...
  '/master/evolution-config': () => import('@/pages/admin/WhatsAppConnectionsPage'),
  '/master/whatsapp-connections': () => import('@/pages/admin/WhatsAppConnectionsPage'),

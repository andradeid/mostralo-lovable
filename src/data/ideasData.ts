...
• readMessages: Marcar como lido`,
    ...
    technicalDetails: {
      title: '🔧 Detalhes Técnicos e Lista Completa de Edge Functions Evolution',
      items: [
        '=== EDGE FUNCTIONS QUE USAM evolution_config (43 functions) ===',
        '',
        '--- 📬 WEBHOOKS (recebem mensagens/eventos) ---',
        '1. whatsapp-webhook - Webhook principal: recebe MESSAGES_UPSERT, SEND_MESSAGE. Usa evolution_config para buscar foto de perfil e nome do cliente. Endpoints: /chat/fetchProfilePictureUrl/{instance}',
        '2. whatsapp-media-webhook - Webhook de mídia: processa imagens, áudios, vídeos, documentos. Usa evolution_config para: buscar foto perfil (/chat/fetchProfilePictureUrl), enviar texto (/message/sendText), enviar mídia (/message/sendMedia)',
        '3. master-whatsapp-webhook - Webhook do master admin: recebe eventos da instância master. Usa evolution_config para processar mensagens do admin',
        '',
        '--- 💬 CHAT E ENVIO DE MENSAGENS ---',
        '4. whatsapp-chat-send - Envia mensagens do chat em tempo real. Usa evolution_config + endpoints: /message/sendText/{instance}, /message/sendMedia/{instance}. TAMBÉM usa /openai/fetchSettings e /openai/settings para pausar bot (ignoreJids)',
        '5. whatsapp-send - Envio genérico de mensagens/mídia. Usa evolution_config + /message/sendText, /message/sendMedia',
        '6. whatsapp-auto-send - Envio automático de notificações (pedidos, status). Usa evolution_config + /message/sendText',
        '7. send-welcome-message - Envia mensagem de boas-vindas para leads. Usa evolution_config + /message/sendText/{instance}',
        '8. send-master-notification - Notifica master admin via WhatsApp. Usa evolution_config + /message/sendText/{instance}',
        '9. send-store-notification - Notifica lojistas via WhatsApp. Usa evolution_config + /message/sendText',
        '10. send-payment-notification - Notifica sobre pagamentos. Usa evolution_config + /message/sendText',
        '11. send-invoice-whatsapp - Envia faturas via WhatsApp. Usa evolution_config + /message/sendText/{instance}',
        '12. send-external-invoice-whatsapp - Envia faturas externas. Usa evolution_config + /message/sendText',
        '13. send-external-receipt-whatsapp - Envia recibos externos. Usa evolution_config + /message/sendText/{instance}',
        '14. send-password-recovery - Envia link de recuperação de senha. Usa evolution_config + /message/sendText',
        '15. send-user-recovery-link - Envia link de recuperação. Usa evolution_config + /message/sendText',
        '16. send-daily-summary - Envia resumo diário. Usa evolution_config + /message/sendText',
        '17. send-diagnostic-audio - Envia áudio de diagnóstico. Usa evolution_config + /message/sendMedia (áudio)',
        '18. booking-confirmation - Confirma agendamentos via WhatsApp. Usa evolution_config + /message/sendText',
        '19. booking-reminder - Lembrete de agendamentos. Usa evolution_config + /message/sendText/{instance}',
        '20. booking-review-request - Solicita avaliação pós-atendimento. Usa evolution_config + /message/sendText/{instance}',
        '21. process-pending-reviews - Processa avaliações pendentes. Usa evolution_config + /message/sendText/{instance}',
        '',
        '--- 🤖 BOT IA / OPENAI ---',
        '22. openai-bot-sync - Sincroniza bot OpenAI com Evolution. Usa evolution_config + endpoints: /openai/creds/{instance} (GET/POST credenciais), /openai/find/{instance} (buscar bots), /openai/delete/{botId}/{instance} (deletar bot), /openai/create/{instance} (criar bot)',
        '23. openai-bot-toggle - Ativa/desativa bot. Usa evolution_config + /openai/status/{instance}/{botId} (PUT)',
        '24. openai-credentials-sync - Sincroniza credenciais OpenAI. Usa evolution_config + /openai/creds/{instance}',
        '25. openai-usage-report - Relatório de uso do bot. Usa evolution_config',
        '26. master-bot-sync - Sincroniza bot do master admin. Usa evolution_config + /openai/creds, /openai/find, /openai/create, /openai/delete',
        '27. master-bot-delete - Deleta bot do master. Usa evolution_config + /openai/delete/{botId}/{instance}',
        '28. master-bot-fetch-prompt - Busca prompt atual. Usa evolution_config + /openai/find/{instance}',
        '29. master-whatsapp-list-bots - Lista bots do master. Usa evolution_config + /openai/find/{instance}',
        '30. master-faq-agent - Agente FAQ do master. Usa evolution_config',
        '31. product-search-agent - Agente de busca de produtos. Usa evolution_config + /message/sendMedia/{instance} para enviar imagens',
        '32. whatsapp-bot-pause - Pausa bot IA. Usa evolution_config + /openai/fetchSettings/{instance} (GET), /openai/settings/{instance} (POST ignoreJids), /openai/changeStatus/{instance} (POST)',
        '33. whatsapp-bot-reactivate - Reativa bot IA. Usa evolution_config + /openai/fetchSettings, /openai/settings (remove ignoreJids), /openai/changeStatus',
        '34. whatsapp-bot-sessions - Gerencia sessões do bot. Usa evolution_config + /openai/fetchSessions/{botId}/{instance} (GET), /openai/changeStatus/{instance} (POST)',
        '35. migrate-openai-creds - Migra credenciais. Usa evolution_config + /openai/creds/{instance}',
        '',
        '--- 📱 INSTÂNCIAS E CONEXÃO ---',
        '36. whatsapp-instance - Gerencia instâncias de lojistas. Usa evolution_config + /instance/create, /instance/connect/{instance}, /instance/logout/{instance}, /instance/delete/{instance}, /instance/fetchInstances, /instance/connectionState/{instance}',
        '37. master-whatsapp-instance - Gerencia instância master. Usa evolution_config + /instance/create, /instance/connect, /instance/logout, /instance/delete, /instance/fetchInstances, /instance/connectionState',
        '38. evolution-test-connection - Testa conexão com Evolution. Usa api_url direta + /instance/fetchInstances',
        '',
        '--- 👤 CONTATOS E PERFIL ---',
        '39. whatsapp-contacts - Busca/importa contatos. Usa evolution_config + /chat/findContacts/{instance}',
        '40. fetch-profile-picture - Busca foto de perfil. Usa evolution_config + /chat/fetchProfilePictureUrl/{instance}',
        '41. validate-whatsapp-number - Valida número WhatsApp. Usa evolution_config + /chat/whatsappNumbers/{instance}',
        '42. validate-whatsapp-batch - Validação em lote. Usa evolution_config + /chat/whatsappNumbers/{instance}',
        '',
        '--- 📊 CAMPANHAS E RELATÓRIOS ---',
        '43. whatsapp-campaign - Envia campanhas em massa. Usa evolution_config + /message/sendText, /message/sendMedia',
        '44. whatsapp-campaign-scheduler - Agenda campanhas. Usa evolution_config',
        '45. sentinela-send - Envia alertas do Sentinela. Usa evolution_config + /message/sendText/{instance}',
        '46. sentinela-check - Verifica status das instâncias. Usa evolution_config',
        '47. sentinela-manual-trigger - Trigger manual do Sentinela. Usa evolution_config',
        '',
        '--- 📈 RELATÓRIOS WHATSAPP ---',
        '48. whatsapp-reports-attendants - Relatórios de atendentes. Consulta dados salvos pelo webhook',
        '49. whatsapp-reports-efficiency - Relatórios de eficiência. Consulta dados salvos pelo webhook',
        '50. whatsapp-reports-kpis - KPIs de atendimento. Consulta dados salvos pelo webhook',
        '51. whatsapp-reports-market - Relatórios de mercado. Consulta dados salvos pelo webhook',
        '52. whatsapp-reports-roi - ROI de atendimento. Consulta dados salvos pelo webhook',
        '53. whatsapp-reports-sales - Relatórios de vendas. Consulta dados salvos pelo webhook',
        '',
        '--- 🔄 FILA E PROCESSAMENTO ---',
        '54. whatsapp-process-queue - Processa fila de mensagens. Invoca whatsapp-auto-send (que usa evolution_config internamente)',
        '',
        '=== ENDPOINTS EVOLUTION API UTILIZADOS (RESUMO) ===',
        '',
        '📤 ENVIO: /message/sendText/{instance}, /message/sendMedia/{instance}',
        '🤖 BOT: /openai/create/{instance}, /openai/find/{instance}, /openai/delete/{botId}/{instance}, /openai/status/{instance}/{botId}, /openai/creds/{instance}, /openai/fetchSettings/{instance}, /openai/settings/{instance}, /openai/fetchSessions/{botId}/{instance}, /openai/changeStatus/{instance}',
        '📱 INSTÂNCIA: /instance/create, /instance/connect/{instance}, /instance/logout/{instance}, /instance/delete/{instance}, /instance/fetchInstances, /instance/connectionState/{instance}',
        '👤 CONTATOS: /chat/findContacts/{instance}, /chat/fetchProfilePictureUrl/{instance}, /chat/whatsappNumbers/{instance}',
        '',
        '=== COMPONENTES FRONTEND QUE USAM evolution_config ===',
        'src/pages/admin/EvolutionConfigPage.tsx - Página de configuração da Evolution API',
        'src/components/shared/OpenAIConfigCard.tsx - Configuração OpenAI (busca modelo do evolution_config)',
        'src/components/admin/test-environment/OpenAIConfigCard.tsx - Config OpenAI do ambiente de teste',
        '',
        '=== AUTENTICAÇÃO E FORMATO ===',
        'Evolution: Header "apikey" + URL customizada (api_url da tabela evolution_config)',
        'UaZapi: Header "token" + URL https://{subdomain}.uazapi.com',
        'Tabela evolution_config: id, api_url, api_key, is_active, openai_creds_id, openai_default_model, openai_max_tokens',
        '',

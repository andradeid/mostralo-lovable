            ...
            <form onSubmit={handlePasswordReset} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <div className="flex items-center space-x-3 rounded-lg border p-3 cursor-pointer hover:bg-muted/50 transition-colors">
                    ...
                    <div>
                      <Label htmlFor="method-email" className="font-medium cursor-pointer">Por Email</Label>
                      <p className="text-xs text-muted-foreground">Receba o link no seu email</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 rounded-lg border border-emerald-200 p-3 cursor-pointer hover:bg-emerald-50/50 dark:hover:bg-emerald-950/20 transition-colors">
                    <RadioGroupItem value="whatsapp" id="method-whatsapp" />
                    <MessageCircle className="w-4 h-4 text-emerald-600" />
                    <div>
                      <Label htmlFor="method-whatsapp" className="font-medium cursor-pointer">Por WhatsApp</Label>
                      <p className="text-xs text-muted-foreground">Receba o link no seu WhatsApp</p>
                    </div>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div className="flex gap-2 pt-2">
                ...
                <Button 
                  ...
                  className={cn(
                    "flex-1",
                    recoveryMethod === 'whatsapp' && "bg-emerald-600 hover:bg-emerald-700"
                  )}

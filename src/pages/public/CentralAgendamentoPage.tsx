...
const CentralAgendamentoPage = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 font-sans w-full overflow-x-hidden">
      ...
      <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden z-10">
        ...
        <div className="relative container px-4 md:px-6 text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-8">
            Transforme sua agenda em uma <strong className="text-white">máquina de faturamento automático</strong> com inteligência, automação e controle total.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="text-lg px-8 py-6 bg-orange-500 hover:bg-orange-600 text-white shadow-lg shadow-orange-500/20" onClick={scrollToPlans}>
              Começar agora
              <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
          </div>
          <p className="text-sm text-slate-500 mt-4">Configuração em menos de 5 minutos • Sem fidelidade</p>
        </div>
      </section>

      {/* QUEBRA DE PADRÃO */}
      <section className="relative py-12 md:py-20 z-10 border-y border-slate-800">
        <div className="absolute inset-0 bg-gradient-to-r from-orange-500/5 via-transparent to-orange-500/5" />
        <div className="relative container px-4 md:px-6 max-w-3xl mx-auto text-center">
          <div className="space-y-6">
            <p className="text-xl md:text-2xl font-medium text-slate-300">
              Quantos clientes você já <strong className="text-orange-400">perdeu</strong> e nem percebeu?
            </p>
            <p className="text-xl md:text-2xl font-medium text-slate-300">
              Quantos horários ficaram <strong className="text-orange-400">vazios</strong> por falta no dia?
            </p>
            <p className="text-xl md:text-2xl font-medium text-slate-300">
              Quantas vezes você ficou <strong className="text-orange-400">preso no WhatsApp</strong> organizando tudo?
            </p>
          </div>
          <div className="mt-10 pt-8 border-t border-slate-800">
            <p className="text-2xl md:text-3xl font-black text-white">
              O problema não é falta de cliente.<br />
              <span className="text-orange-400">É falta de controle.</span>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-16 md:py-24 z-10">
        <div className="container px-4 md:px-6 max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto">
            O sistema que organiza sua agenda, traz clientes de volta automaticamente e <strong className="text-white">garante seu faturamento antes mesmo do atendimento acontecer.</strong>
          </p>
        </div>
      </section>
      ...
      <section className="relative py-12 md:py-20 z-10">
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-white">Os 3 Pilares do Crescimento</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {/* Pilar 1 */}
            <div className="p-8 text-center rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-orange-500/30 transition-all backdrop-blur-sm">
              <div className="w-16 h-16 rounded-2xl bg-orange-500/10 flex items-center justify-center mx-auto mb-6">
                <Calendar className="w-8 h-8 text-orange-400" />
              </div>
              <h3 className="text-xl font-bold mb-4 text-white">Controle Total da Agenda</h3>
            ...
            {/* Pilar 2 */}
            <div className="p-8 text-center rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-green-500/30 transition-all backdrop-blur-sm">
              <div className="w-16 h-16 rounded-2xl bg-green-500/10 flex items-center justify-center mx-auto mb-6">
                <DollarSign className="w-8 h-8 text-green-400" />
              </div>
              <h3 className="text-xl font-bold mb-4 text-white">Faturamento Automatizado</h3>
              <ul className="space-y-3 text-left text-slate-400">
                <li className="flex items-start gap-2">
            ...
            {/* Pilar 3 */}
            <div className="p-8 text-center rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-purple-500/30 transition-all backdrop-blur-sm">
              <div className="w-16 h-16 rounded-2xl bg-purple-500/10 flex items-center justify-center mx-auto mb-6">
                <Brain className="w-8 h-8 text-purple-400" />
              </div>
              <h3 className="text-xl font-bold mb-4 text-white">Crescimento Inteligente</h3>
              <ul className="space-y-3 text-left text-slate-400">
                <li className="flex items-start gap-2">
        ...
        <div className="container px-4 md:px-6 max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">
              ...
              <span className="text-orange-400">este faz você faturar.</span>
            </h2>
          </div>
          <div className="grid sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
            {[
              ...
              <div key={i} className="flex items-center gap-4 p-4 rounded-xl bg-slate-900/50 border border-slate-800 hover:border-slate-700 transition-colors">
      ...
      {/* COMO FUNCIONA */}
      <section className="relative py-16 md:py-24 z-10 border-y border-slate-800">
        <div className="container px-4 md:px-6 max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">
              Como funciona?
            </h2>
            <p className="text-slate-400 text-lg">Simples. Direto. Sem complicação.</p>
          </div>
      ...
      {/* PLANOS */}
      <section id="planos" className="relative py-16 md:py-24 z-10">
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">
              Escolha o plano ideal para o seu negócio
            </h2>
            <p className="text-slate-400 text-lg">Sem fidelidade. Cancele quando quiser.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto items-stretch">
            {/* Profissional */}
            <div className="p-8 flex flex-col rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-slate-700 transition-all">
              <div className="mb-6">
                <h3 className="text-xl font-bold text-white mb-1">Profissional</h3>
                <p className="text-sm text-slate-500">Para quem precisa organizar</p>
              </div>
              <div className="mb-6">
              ...
              <Button variant="outline" size="lg" className="w-full border-slate-700 text-slate-300 hover:bg-slate-800 hover:text-white" onClick={scrollToPlans}>
                Começar agora
              </Button>
            </div>
            ...
            <div className="p-8 flex flex-col rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-slate-700 transition-all">
              <div className="mb-6">
                ...
                <p className="text-sm text-slate-500">Para quem quer crescer</p>
              </div>
              <div className="mb-6">
            ...
            {/* Premium - DESTACADO */}
            <div className="p-8 flex flex-col rounded-2xl bg-gradient-to-b from-orange-500/10 to-slate-900/80 border-2 border-orange-500/40 shadow-xl shadow-orange-500/10 relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                <span className="bg-orange-500 text-white text-xs font-bold px-4 py-1.5 rounded-full shadow-md">
                  ⭐ Mais escolhido
                </span>
              </div>
              <div className="mb-6 mt-2">
                <h3 className="text-xl font-bold text-white mb-1">Premium</h3>
                <p className="text-sm text-slate-400">Para quem quer dominar o mercado</p>
              </div>
              <div className="mb-6">
                <span className="text-4xl font-black text-orange-400">R$597</span>
                <span className="text-slate-500">/mês</span>
              </div>
              <ul className="space-y-3 mb-8 flex-1">
                {[
              ...
              <Button size="lg" className="w-full bg-orange-500 hover:bg-orange-600 text-white shadow-lg shadow-orange-500/20">
        ...
        <div className="relative container px-4 md:px-6 max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 mb-10">
            {[
              ...
              <div key={i} className="flex items-center gap-3 p-4 rounded-xl bg-slate-900/50 border border-slate-800">
          ...
          <p className="text-center text-xl font-bold text-white">
            Decisão baseada em <span className="text-orange-400">dados</span>, não em achismo.
          </p>
        </div>
      </section>
        ...
        <div className="container px-4 md:px-6 max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={i} className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-slate-700 transition-all">
                <p className="text-lg font-bold text-white mb-2">{item.question}</p>
      ...
      <section className="relative py-16 md:py-24 z-10">
        ...
        <div className="relative container px-4 md:px-6 max-w-3xl mx-auto text-center">
          <p className="text-xl md:text-2xl text-slate-400 mb-6">
            Se você continuar como está, vai continuar <strong className="text-white">perdendo dinheiro sem perceber.</strong>
          </p>
          <p className="text-xl md:text-2xl font-bold text-white mb-10">
            Se usar o sistema certo, sua agenda se organiza, seus clientes voltam e seu <span className="text-orange-400">faturamento cresce.</span>
          </p>
          <Button size="lg" className="text-lg px-10 py-6 bg-orange-500 hover:bg-orange-600 text-white shadow-xl shadow-orange-500/20" onClick={scrollToPlans}>
            Começar agora
            <ArrowRight className="ml-2 w-5 h-5" />
          </Button>
          <p className="text-sm text-slate-500 mt-4">Leva menos de 5 minutos para configurar</p>
        </div>
      </section>

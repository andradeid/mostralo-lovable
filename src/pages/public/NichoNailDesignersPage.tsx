  ...
  <section className="py-20 bg-gradient-to-b from-zinc-900 to-zinc-950">
    <div className="container mx-auto px-4">
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <p className="text-xl text-zinc-400">
          Crie planos como <strong className="text-white">"Manutenção Mensal Garantida"</strong> ou{' '}
          <strong className="text-white">"Plano Esmaltação em Gel"</strong> e tenha receita recorrente.
        </p>
      </div>
          ...
          <CardContent className="p-6">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-zinc-300">
                <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                <span>Planos como "Manutenção Mensal" ou "VIP Nail Art"</span>
              </li>
              <li className="flex items-start gap-3 text-zinc-300">
                <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
        ...
        <Card className="bg-zinc-950 border-zinc-800 hover:border-violet-500/50 transition-all duration-300 hover:-translate-y-2 overflow-hidden">
          ...
          <CardContent className="p-6">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-zinc-300">
                <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                <span>Veja todas as assinantes em um só lugar</span>
              </li>
              <li className="flex items-start gap-3 text-zinc-300">
                <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
        ...
        <Card className="bg-zinc-950 border-zinc-800 hover:border-violet-500/50 transition-all duration-300 hover:-translate-y-2 overflow-hidden">
          ...
          <CardContent className="p-6">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3 text-zinc-300">
                <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                <span>Cliente nunca passa da manutenção!</span>
              </li>
            </ul>
          </CardContent>
        </Card>
        ...
        <Card className="bg-zinc-950 border-zinc-800 hover:border-violet-500/50 transition-all duration-300 hover:-translate-y-2 overflow-hidden">
          ...
          <CardContent className="p-6">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3 text-zinc-300">
                <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                <span>Cliente fidelizada por contrato mensal</span>
              </li>
              <li className="flex items-start gap-3 text-zinc-300">
                <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
      ...
      <div className="max-w-md mx-auto">
        <Card className="bg-gradient-to-br from-violet-500/20 to-purple-500/20 border-violet-500/50 overflow-hidden">
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-2xl font-bold text-white mb-2">Plano Manutenção Mensal</h3>
            <p className="text-zinc-400 mb-4">1 manutenção garantida por mês</p>
            <div className="flex items-baseline justify-center gap-1 mb-4">
              <span className="text-zinc-500">R$</span>
              <span className="text-5xl font-bold text-violet-400">199</span>
              <span className="text-zinc-500">/mês</span>
            </div>
            <div className="flex items-center justify-center gap-2 text-green-400">
              <CheckCircle className="w-5 h-5" />
              <span>Cliente nunca atrasa a manutenção!</span>
            </div>
          </CardContent>
        </Card>
      </div>
...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Você cria planos como "Manutenção Mensal Garantida" ou "Plano Esmaltação em Gel". A cliente paga mensalmente e pode agendar conforme o plano permitir. O sistema reconhece automaticamente a assinante e marca o serviço como incluso. Cliente nunca mais passa do prazo da manutenção!'
  }
];

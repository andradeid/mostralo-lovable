...
const ShortLinkRedirect = lazy(() => import("@/pages/public/ShortLinkRedirect"));
...
export const publicRoutes = (
  ...
  <Route path="/nicho-suplementos" element={<LazyRoute><NichoSuplementosPage /></LazyRoute>} />
    ...
    <Route path="/nicho-foodtruck" element={<LazyRoute><NichoFoodTruckPage /></LazyRoute>} />
      ...
      <Route path="/central-agendamento" element={<LazyRoute><CentralAgendamentoPage /></LazyRoute>} />
    ...
    <Route path="/assinaturas/:storeSlug" element={<LazyRoute><PublicSubscriptionPlansPage /></LazyRoute>} />

-- Atualizar trigger para incluir coordenadas do cliente para o link do Google Maps
...
DECLARE
  ...
  supabase_url TEXT;
BEGIN
  -- Buscar dados da loja incluindo novos campos
  SELECT 
    s.id,
    s.name,
  ...
  -- Determinar número de destino (prioridade: notification_phone > notification_phone_2 > instance_phone > whatsapp > phone)
  ...
  -- Montar payload com novos campos incluindo coordenadas
